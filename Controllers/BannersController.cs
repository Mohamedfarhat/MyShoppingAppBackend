...
namespace MyShoppingAppBackend.Controllers
{
    ...
    public class BannersController : ControllerBase
    {
        ...
        public BannersController(MyShoppingAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Banner>> PostBanner(Banner banner)
        {
            ...
            return CreatedAtAction("GetBanner", new { id = banner.BannerImgId }, banner);
        }
        ...
        {
            return _context.Banners.Any(e => e.BannerImgId == id);
        }
    }
}
